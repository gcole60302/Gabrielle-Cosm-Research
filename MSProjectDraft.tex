...
\begin{figure}[!ht]
    ...
    \subfloat[Z= 0.22\label{subfig-1:dummy}]{%
      \includegraphics[scale=0.50, width=.60\textwidth]{Arnaud_All_Masses_Z_0.22_150GHz.pdf}
    }
    \vfill
	\center
    \subfloat[Z= 0.55\label{subfig-2:dummy}]{%
      \includegraphics[scale=0.50, width=.60\textwidth]{Arnaud_All_Masses_Z_0.55_150GHz.pdf}
	}
    \vfill
	\center
    \subfloat[ Z= 1.00\label{subfig-2:dummy}]{%
      \includegraphics[scale=0.50, width=.60\textwidth]{Arnaud_All_Masses_Z_1.00_150GHz.pdf}
	}
